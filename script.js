window.onload = function () {
    ...
    if (!isMobile) {
        ...
        webText.innerText = "Descarga la App escaneando el QR:";

        var webQrImage = document.createElement("img");
        webQrImage.src = "qr-apk.png"; // Replace with the actual path to your QR code image
        webQrImage.alt = "QR Code";
        webQrImage.classList.add("max-w-full", "h-auto", "mx-auto", "fade-in", "w-1/2"); // Add styling as needed

        var linkContainer = document.createElement("div");
        linkContainer.classList.add("flex", "w-full", "justify-center", "md:justify-start", "pb-24", "lg:pb-0", "fade-in");
        linkContainer.appendChild(webQrImage);
